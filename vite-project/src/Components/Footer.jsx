...
const Footer = () => {
  // Mapping links to icons for Quick Links
  const links = [
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-6">
              <div className="h-auto w-48 transition-transform duration-300 hover:scale-105">
                <img 
                  src={webzon2} 
                  alt="Webzon Logo" 
            ...
            <p className="text-gray-400 leading-relaxed mb-6 text-lg max-w-md">
              ...
              to achieve digital excellence with cutting-edge technology.
            </p>
          </div>

          {/* Quick Links Section with Icons */}
          <div>
            <h3 className="font-black text-xl mb-6 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-5 text-gray-400">
              <li className="flex items-start gap-3 group">
                <Mail className="w-5 h-5 text-blue-500 mt-0.5 group-hover:scale-110 transition-transform" />
